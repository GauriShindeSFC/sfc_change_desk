...
export const serializeChangeRequest = (row) => {
  ...
  return {
    ...
    hostname: cr.hostname || cr.customFieldValues?.hostname || cr.customFieldValues?.assetId || null,
    environment: cr.environment || cr.customFieldValues?.environment || 'Production',

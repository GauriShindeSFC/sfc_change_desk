    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: '1rem 1.75rem 1.5rem 1.75rem', borderTop: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '0.75rem', backgroundColor: 'var(--card-bg)', position: 'sticky', bottom: 0 }}>
          ...
          <button onClick={() => { if (onSendBack) onSendBack(cr.id); onClose(); }} style={{ padding: '0.55rem 1.1rem', backgroundColor: '#FFFBEB', color: '#B45309', border: '1px solid #FCD34D', borderRadius: '8px', fontSize: '0.825rem', fontWeight: 700, cursor: 'pointer' }}>Send back to user</button>
